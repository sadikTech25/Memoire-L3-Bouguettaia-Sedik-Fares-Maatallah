...
<head>
    <meta charset="utf-8">
    <title>Suppliers - UltraEvent</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="suppliers.php" class="nav-item nav-link active"><i class="fa fa-truck me-2" aria-hidden="true"></i>suppliers</a>
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="search-container">
                    ...
                    <i class="fa fa-search"></i>
                        <input class="form-control border-0" id="searchInput" type="search" placeholder="Search for Suppliers .." style="width:400px">
                    </form>
                </div>
