...
<head>
    <meta charset="utf-8">
    <title>My Ressources- UltraEvent</title>
    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="index_fournisseur.php" class="nav-item nav-link active"><i class="fa fa-calendar-times me-2"></i>My Ressources</a>
                    <a href="addressources.php" class="nav-item nav-link "><i class="fa fa-plus me-2"></i>Add Ressources</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                <a href="index_fournisseur.php" class="navbar-brand d-flex d-lg-none me-4">
                </a>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div><a href="addressources.php"><button type="button" class="btn btn-primary" style="margin:15px;">
                        <i class="fas fa-plus"></i> Add Ressources
                      </button></a>
                    </div> 
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">My Ressources</h6>
                    </div>
                    <div id="displaysupplierressource" class="table-responsive" style="min-height:350px;">
                    </div>
                </div>
            </div>
            <!-- Recent Sales End -->
