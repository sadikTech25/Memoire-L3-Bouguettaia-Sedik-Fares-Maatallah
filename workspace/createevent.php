...
<head>
    <meta charset="utf-8">
    <title>Create Event - UltraEvent</title>
    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="createevent.php" class="nav-item nav-link active"><i class="fas fa-plus me-2"></i>Create Event</a>
                    <a href="client_demanded_events.php" class="nav-item nav-link "><i class="fa fa-list me-2"></i>Demanded Events</a>
                    <a href="client_refused_events.php" class="nav-item nav-link"><i class="fa fa-calendar-times me-2"></i>Refused Events</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto" style="margin:12px">
...
<form action="submitevent.php" method="post" >
                <div class="form-floating mb-3">
                    <input name="titre" class="form-control" id="floatingInput" placeholder="title" required>
                ...
                <div class="form-floating mb-3">
                    <select name="type" class="form-select" id="floatingSelect" aria-label="Floating label select example" required>
                        <option  value="0" selected="">Cultural Event</option>
                        <option value="1">Sporting Event</option>
                        <option value="2">Educational Event</option>
                        <option value="3">Workshop</option>
                        <option value="4">Birthday</option>
                        <option value="5">Mariage</option>
                        <option value="6">Party</option>
                    </select>
                    <label for="floatingSelect">Event Type</label>
                </div>
                <div  class="form-floating mb-3">
                    <textarea name="description" class="form-control" placeholder="Leave a comment here" id="floatingTextarea" style="height: 150px;" min="30" max="200" required></textarea>
                    <label for="floatingTextarea">Description</label>
                </div>
                <div  class="form-floating mb-3">
                    <input name="datedebut" type="date" class="form-control" id="floatingInput" placeholder="title" required>
                    <label for="floatingInput">Start Date</label>
                </div>
                <div  class="form-floating mb-3">
                    <input name="datefin" type="date" class="form-control" id="floatingInput" placeholder="title" required>
                    <label for="floatingInput">End Date</label>
                </div>
                <div  class="form-floating mb-3">
                    <input name="lieu" class="form-control" id="floatingInput" placeholder="title" required>
                    <label for="floatingInput">Location</label>
                </div>
                <div class="resource-group">
                    <div  class="form-floating mb-3">
                        <select name="type_ressource[]" class="form-select" id="floatingSelect" aria-label="Floating label select example" required>
                        ...
                        <label for="floatingSelect">Ressources Needed</label>
                    </div>
                    <div  class="form-floating mb-3">
                        <input type="number" name="quantite_ressource[]" class="form-control quantity-picker-input" id="floatingQuantity" value="1" aria-label="Quantity">
                        <label for="floatingSelect">Ressources Quantity</label>
                    </div>
                </div>
                    <div  class="form-floating mb-3">
                        <button type="button" class="btn btn-primary mb-3 add-resource-btn">
                             <i class="bi bi-plus-circle"> </i> Add Resource
                        </button>
                    </div>
                
                <input name="image" class="form-control form-control-lg mb-3" id="formFileLg" type="file">
                <div class="form-floating mb-3">
                <button type="submit" class="btn btn-primary mb-3">Submit Event</button>
