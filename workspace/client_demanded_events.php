...
<head>
    <meta charset="utf-8">
    <title>Demanded Events - UltraEvent</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <a href="index_client.php" class="nav-item nav-link"><i class="fa fa-calendar-check me-2" aria-hidden="true"></i>Accepted Events</a>
                    ...
                    <a href="client_demanded_events.php" class="nav-item nav-link active"><i class="fa fa-list me-2"></i>Demanded Events</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div id="displaydemandedevent" class="table-responsive" style="min-height:350px">
                    </div>
                </div>
            </div>
            <!-- Recent Sales End -->
