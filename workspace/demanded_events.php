...
<head>
    <meta charset="utf-8">
    <title>Demanded Event - UltraEvent</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="demanded_events.php" class="nav-item nav-link active"><i class="fa fa-list me-2"></i>Demanded Events</a>
                    ...
                    <a href="refused_events.php" class="nav-item nav-link"><i class="fa fa-calendar-times me-2"></i>Refused Events</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Demanded Events</h6>
                        <a href="">Show All</a>
                    </div>
                    <div  id="displaydemandedevent" class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td> <button type="button" class="btn btn-primary open-popup-btn" data-toggle="modal" data-target="#exampleModal">
                                        Validate
                                       </button></td>
                                ...
                                <tr>
                                    ...
                                    <td>tables,lights,speakers....</td>
                                    <td>
                                        <button type="button" class="btn btn-primary open-popup-btn" data-toggle="modal" data-target="#exampleModal">
                                       Validate
                                      </button></td>
                                </tr>
                            </tbody>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ante felis, gravida at odio viverra, blandit suscipit leo. Fusce mattis justo at diam laoreet, sed pretium leo semper.
                    </div>
