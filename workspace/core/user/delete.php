...
if ($idutilisateur > 0) {
    ...
    INNER JOIN evenement e ON em.evenement = e.id_evenement
    WHERE em.manager = :idutilisateur AND e.etat_evenement = 1"); // Check for ongoing events
    ...
    if ($eventCount > 0) {
        ...
        $msg = "Impossible de supprimer l'utilisateur car il a des événements en cours.";
    } else {
