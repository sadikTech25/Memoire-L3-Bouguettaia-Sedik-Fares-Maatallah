...
<head>
    <meta charset="utf-8">
    <title>Managers - UltraEvent</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="index_admin.php" class="nav-item nav-link "><i class="fa fa-list me-2"></i>Ressources</a>
                    <a href="managers.php" class="nav-item nav-link active"><i class="fa fa-user me-2"></i>Managers</a>
                    <a href="suppliers.php" class="nav-item nav-link"><i class="fa fa-truck me-2" aria-hidden="true"></i>suppliers</a>
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="search-container">
                    ...
                    <i class="fa fa-search"></i>
                        <input class="form-control border-0" id="searchInput" type="search" placeholder="Search for Managers .." style="width:400px">
                    </form>
                </div>
