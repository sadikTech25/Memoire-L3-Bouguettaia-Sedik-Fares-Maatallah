...
<head>
    <meta charset="utf-8">
    <title>My Accepted Events - UltraEvent</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="index_client.php" class="nav-item nav-link active"><i class="fa fa-calendar-check me-2" aria-hidden="true"></i>Accepted Events</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">My Accepted Events</h6>
                    </div>
                    <div id="displayacceptedevent" class="table-responsive" style="min-height:350px">
                    </div>
                </div>
            </div>
            <!-- Recent Sales End -->
